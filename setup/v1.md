...
!! Note: This is the old setup steps before using Flux and when still using the RPi node. !!
Kept for archiving sake, but the most recent docs are in [README.md](./README.md).
